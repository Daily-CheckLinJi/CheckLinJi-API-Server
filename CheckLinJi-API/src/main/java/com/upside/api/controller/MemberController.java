...
public class MemberController {
	...
	public ResponseEntity<Map<String, String>> fcmUpdate (@RequestBody MemberDto memberDto , @RequestHeader("Authorization") String authHeader) {			
		
		 String userEmail = jwtTokenProvider.getEmail(authHeader); // email을 얻기위해 헤더에서 토큰을 디코딩하는 부분이다. 		 	
		
		 memberDto.setEmail(userEmail);
		 
		 Map<String, String> result = memberService.fcmUpdate(memberDto);
